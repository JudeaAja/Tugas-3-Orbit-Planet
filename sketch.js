...
function preload(){
  ...
  bumi_ = loadImage("earth.png")
  mars_ = loadImage("mars.png")
  moon_ = loadImage("moon.png")
  space = loadImage("space.jpg")
  return planetimage = [mercury_, venus_ , bumi_ , mars_]
}
...
function draw() {
  background('#2F00B2')
  let name = ['Mercury', 'Venus', 'Bumi', 'Mars']
  ...
  sun.show(sun_)
  text('Matahari',sun.pos.x,sun.pos.y)
  textSize(25)
}
...
function Body(_mass, _pos, _vel){
  ...
  this.show = function(pic) {
    ...
    fill(random(0, 255), random(0, 255), random(0, 255)); //noStroke()
